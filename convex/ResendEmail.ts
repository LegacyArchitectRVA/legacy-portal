...
async function sendEmail({
  ...
  if (!response.ok) {
    ...
    throw new ConvexError(`Failed to send email via Resend: ${error}`);
  }
}

/**
 * Email verification provider for the sign-up flow, sent via Resend.
 */
...
/**
 * Password reset email provider, sent via Resend.
 */
