...
const AdminVisualEditorPage = lazy(
  () => import("./pages/AdminVisualEditorPage"),
);
...
const DocumentConversionPage = lazy(
  () => import("./pages/DocumentConversionPage"),
);
          ...
          <Routes>
            ...
            <Route element={<ProtectedRoute />}>
              ...
              <Route element={<AppLayout />}>
                ...
                <Route
                  path="/admin/client/:clientUserId"
                ...
                />
                <Route
                  path="/admin/blueprint/:sessionId"
                  element={<BlueprintSessionPage />}
                />
                <Route path="/admin/import" element={<ManualImportPage />} />
                <Route
                  path="/admin/visual-editor"
                  element={<AdminVisualEditorPage />}
                />
                <Route
                  path="/admin/hubspot"
                  element={<HubSpotSettingsPage />}
                />
                <Route path="/generate" element={<GeneratePage />} />
                <Route
                  path="/manual/:clientUserId"
                  element={<ManualViewPage />}
                />
