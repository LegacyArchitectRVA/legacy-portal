...
const STATUS_BADGE: Record<string, { label: string; cls: string; Icon: any }> =
  {
    ...
    delivered: {
      label: "Delivered",
      cls: "text-gold-primary bg-gold-dark/15",
      Icon: Sent,
    },
  };
    ...
    <div className="max-w-4xl mx-auto px-4 py-8 space-y-5 animate-fade-in">
      <div className="flex items-center gap-3">
        <button
          ...
          className="text-[#f2ede2]/75 hover:text-gold-primary transition-colors"
        >
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-xs text-[#f2ede2]/75 mt-0.5">
            One sit-down. A Gap Map and a 72-hour plan. $249 credits toward any
            edition.
          </p>
        </div>
        <button
      ...
      {sessions === undefined ? (
        ...
        <div className="text-center py-16 space-y-3">
          <p className="text-sm text-[#f2ede2]/75">
            No sessions yet. Start one when the prospect sits down.
          </p>
        </div>
      ) : (
              ...
              >
                <div className="flex items-center justify-between gap-3">
                  <div className="min-w-0">
                    ...
                    <p className="text-xs text-[#f2ede2]/75 mt-0.5">
                      ...
                      {/* Colored to match the Gap Map / checkpoint chip palette
                          exactly (STATUS_COLORS.exposed in lib/gapMapStatus.ts)
                          rather than a generic Tailwind red, so "exposed" reads
                          the same shade everywhere in the app. */}
                      <span
                  ...
                  <div className="flex items-center gap-2 shrink-0">
                    <span
                      className={`flex items-center gap-1 text-[10px] font-heading px-2 py-1 rounded-full ${badge.cls}`}
                    >
                    ...
                    <button
                      ...
                      className="opacity-60 group-hover:opacity-100 transition-opacity text-[#f2ede2]/50 hover:text-red-400"
        ...
        >
          ...
          >
            ...
            <div className="flex gap-2 justify-end pt-1">
              <button
                onClick={() => setShowNew(false)}
                className="text-xs text-[#f2ede2]/75 px-3 py-2"
              >
                Cancel
              </button>
              <button
          ...
          >
            ...
            <div className="flex gap-2 justify-end">
              ...
              <button
                onClick={() => {
                  deleteSession({
                    sessionId: confirmDelete as Id<"blueprintSessions">,
                  });
