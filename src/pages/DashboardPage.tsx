      ...
      <div className="min-h-screen flex items-center justify-center px-4">
        <div className="max-w-md w-full text-center space-y-6">
          ...
          <p className="text-[#f2ede2]/80 leading-relaxed">
            Your account has been created, but your portal access hasn't been
            activated yet. Once your service agreement is signed and confirmed,
            your facilitator will unlock your Life Manual.
          </p>
          <p className="text-sm text-[#f2ede2]/80">
            Questions?{" "}
            <a
              href="mailto:help@legacyarchitectrva.com"
              className="text-gold-primary hover:text-gold-bright transition-colors font-medium"
            >
