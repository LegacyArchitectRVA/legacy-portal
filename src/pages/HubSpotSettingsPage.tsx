    ...
    <div className="max-w-3xl mx-auto px-4 py-8 space-y-6">
      ...
      <div className="bg-[#0f0c08] rounded-xl border border-gold-border overflow-hidden">
        ...
        <div className="p-6 space-y-6">
          {/* API Key Input */}
          <div>
            <label className="block text-sm font-medium text-[#f2ede2] mb-2">
            ...
            <div className="relative">
              <input
                ...
                className="w-full bg-black border border-gold-border/30 rounded-lg px-4 py-3 text-[#f2ede2] placeholder:text-[#f2ede2]/30 focus:outline-none focus:border-gold-primary font-mono text-sm"
              />
              <button
                onClick={() => setShowApiKey(!showApiKey)}
                className="absolute right-3 top-1/2 -translate-y-1/2 text-[#f2ede2]/50 hover:text-gold-primary transition-colors"
              >
                {showApiKey ? (
          ...
          <div className="flex items-center gap-3">
            <button
              onClick={handleSave}
              disabled={saving}
              className="flex items-center gap-2 bg-gradient-to-r from-[#d4b661] to-[#7D6224] text-[#0f0c08] font-heading text-sm font-semibold px-4 py-2 rounded-full hover:opacity-90 transition-opacity disabled:opacity-50"
            >
              {saving ? (
                <>
      ...
      <div className="bg-[#0f0c08] rounded-xl border border-gold-border overflow-hidden">
        ...
        <div className="p-6">
          <ol className="space-y-4 text-sm text-[#f2ede2]/75">
