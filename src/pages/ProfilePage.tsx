      ...
      <div className="bg-[#0a0a0a] rounded-xl p-6 gold-border-glow space-y-6">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-5">
          ...
          <div className="relative group shrink-0">
            <div className="w-24 h-24 rounded-full bg-[#111] flex items-center justify-center border-2 border-[rgba(217,204,160,0.15)] overflow-hidden shadow-[0_0_15px_rgba(217,204,160,0.06)]">
              {profilePicPreview ? (
                ...
                <User className="w-12 h-12 text-[#d9cca0]/60" />
              )}
            </div>
            <button
              type="button"
          ...
          <div className="flex-1 text-center sm:text-left">
            ...
            <p className="text-sm text-[#e8e6e1]/60 mt-0.5">{profile?.email}</p>
          ...
          {/* Family Crest */}
          <div className="relative group shrink-0">
            <div className="w-24 h-24 rounded-xl bg-[#111] flex flex-col items-center justify-center border-2 border-[rgba(217,204,160,0.15)] overflow-hidden gap-1 shadow-[0_0_15px_rgba(217,204,160,0.06)]">
              {crestPreview ? (
                <img src={crestPreview} alt="Family Crest" className="w-full h-full object-contain p-2" />
              ) : (
                <>
                  <Crown className="w-8 h-8 text-[#d9cca0]/50" />
                  <span className="text-[9px] text-[#d9cca0]/50 font-heading uppercase tracking-wider">Crest</span>
                </>
              )}
            </div>
            <button
            ...
            />
            <p className="text-[9px] text-[#e8e6e1]/50 mt-1.5 text-center font-heading tracking-wide">Family Crest</p>
          </div>
        </div>
        ...
        <div className="space-y-4">
          <div>
            <label className="block text-xs text-[#e8e6e1]/60 mb-1.5 font-heading uppercase tracking-wider">
              Full Name
            </label>
            <input
              type="text"
          ...
          <div>
            ...
            <input
              ...
              value={profile?.email || ""}
              disabled
              className="w-full bg-black border border-[rgba(217,204,160,0.08)] rounded-lg px-4 py-3 text-sm text-[#e8e6e1]/50 cursor-not-allowed"
            />
          </div>
